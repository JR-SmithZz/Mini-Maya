...
protected:
    ...
    GLuint bufUV;
    GLuint bufTotal;                // Instead, we use a uniform vec4 in the shader to set an overall color for the geometry
    GLuint bufPower;
    GLuint bufAni;                // Instead, we use a uniform vec4 in the shader to set an overall color for the geometry
